...
name: daily-briefing
description: >-
  Use when the user asks about their plan, agenda, to-do list, schedule, what's
  on their plate, what they should work on, morning briefing, or any synonym.
  Builds the complete daily picture — calendar events, pull requests awaiting
  review or assigned, and every task from TASKS.md.
targets:
  - '*'
---
# Daily Briefing
